<?php 
	...
	class UserController extends Controller{
		...
		public function doAdd(){
			...
			$this->insert();
			//quay tro lai duong dan
			echo "<script>alert(\"Cập nhật thông tin thành công\");document.location = 'index.php?area=backend&controller=User';</script>";
			//header("location:index.php?area=backend&controller=User");
		}
		//do update account
		public function UpdateAccount(){
			$this->renderHTML("Views/Frontend/UpdateAccountView.php");
		}
		//do update account
		public function doUpdate(){
			...
			$this->update1($id);
			//quay tro lai duong dan
			echo "<script>alert(\"Cập nhật thông tin thành công\");document.location = 'index.php?area=backend&controller=User&action=UpdateAccount';</script>";
			//header("index.php?area=backend&controller=User&action=UpdateAccount");
		}
		//delete user
