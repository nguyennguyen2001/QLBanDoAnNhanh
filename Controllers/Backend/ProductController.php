<?php 
	...
	class ProductController extends Controller{
		...
		public function detail(){
			...
			$formAction = "index.php?area=backend&controller=Product&action=doDetail&id=$id";
			//goi view, truyen du lieu ra view
			$this->renderHTML("Views/Backend/DetailProductView.php",array("record"=>$record,"formAction"=>$formAction));
		}
		//do detail Product
