...
<div class="content">
    <div class="container">
        <h1 style="display:none;">Light Chicken</h1>
        <!-- category product -->
        <div class="slideshow">
            <div class="row">
                ...
                <div class="online_support block">
                    ...
                    <div class="block-content">
                        <div class="sp_1">
                            ...
                            <p>Nguyễn Bình Nguyên: 0983xxxxxx</p>
                        </div>
                        <div class="sp_1">
                            <p>Tư vấn bán hàng 2</p>
                            <p>Nguyễn Văn Long: 0976xxxxxx</p>
                        </div>
                        <div class="sp_1">
                            <p>Email liên hệ</p>
...
<footer id="footer">
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> © Bản quyền thuộc về Ligh Chicken</div>
