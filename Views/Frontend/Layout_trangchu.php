...
<head>
    ...
    <link rel="shortcut icon" href="Assets/frontend/100/047/633/themes/517833/assets/lotteria_logo1.png?1481775169361" type="image/x-icon" />
...
<div class="content">
    <div class="container">
        <h1 style="display:none">NGUYÊN</h1>
        <div class="row">
            <div class="col-xs-12 col-md-3">
            <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/a5.jpg" class="img-thumbnail" style="width: 286px;height: 160px;"></div>
                </div>
                <div class="row" style="margin-bottom: 5px;">
                    <div class="col-md-12"><img src="Assets/frontend/images/a6.jpg" class="img-thumbnail" style="width: 286px;height: 160px;"></div>
                </div>
                <div class="row">
                    <div class="col-md-12"><img src="Assets/frontend/images/a7.jpg" class="img-thumbnail" style="width: 286px;height: 160px;"></div>
                </div>
            </div>
            <div class="col-md-9">
                <!-- slide -->
                <div class="owl-slider">
                    <div class="item">
                        ...
                        <div id="myCarousel" class="carousel slide" data-ride="carousel">
                            ...
                            <div class="item active"> <img style="height: 500px;width: 1000px;" src="Assets/frontend/images/a11.jpg" alt="Los Angeles"> </div>
                                <div class="item"> <img style="height: 500px;width: 1000px;" src="Assets/frontend/images/a22.jpg" alt="Los Angeles"> </div>
                                <div class="item"> <img style="height: 500px;width: 1000px;" src="Assets/frontend/images/a33.jpg" alt="Chicago"> </div>
                                <div class="item"> <img style="height: 500px;width: 1000px;" src="Assets/frontend/images/a44.jpg" alt="New York"> </div>
                            </div>
        ...
        <?php
        //<!-- adv -->
       // <div class="widebanner"> <a href="#"><img src="Assets/frontend/100/047/633/themes/517833/assets/biac1.jpeg?1481775169361" alt="#" class="img-responsive" style="width: 100%;"></a> </div>
       // <!-- end adv -->
        ?>
    </div>
</div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-4">
                ...
                <div class="info">
                    <h3>Giao hàng nhanh nhẹn</h3>
                    <p>Giao hàng nhanh chóng chất lượng</p>
                </div>
            </div>
            <div class="col-xs-12 col-sm-4">
...
<footer id="footer">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-3">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="http://localhost/php41_project_product/index.php">Trang chủ</a></li>
    ...
    <div class="bottom-footer">
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-5"> © Copyright belongs to Light Chicken</div>
