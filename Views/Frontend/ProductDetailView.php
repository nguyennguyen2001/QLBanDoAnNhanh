    ...
    <div class="top">
        <div class="row">
            ...
            <div class="col-xs-12 col-md-6 info">
                <h1 itemprop="name"><img src="Assets/Frontend/100/047/633/themes/517833/assets/tren.jpg" style="width: 410px;height: 50px;"></h1>

                <p itemprop="price" class="price-box product-price-box"> <span class="special-price"> <span class="price product-price"> <?php echo number_format($record->price); ?>VNĐ </span> </span> </p>
                <h4  class="sl">Số lượng còn: <?php echo $record->SL; ?> </h4>
