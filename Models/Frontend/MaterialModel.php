<?php
  trait MaterialModel{
      ...
      public function fetchAll($from, $pageSize){
          ...
          $conn = Connection::getInstance();
          //thuc thi truy van
          $query = $conn->query("select * from tbl_material where MaKho=$id order by id desc limit $from, $pageSize");
      ...
      public function totalRecord(){
          ...
          $conn = Connection::getInstance();
          //thuc thi truy van
          $query = $conn->query("select MaNL from tbl_material where MaKho=$id");
