...
trait CartModel{
    ...
    public function listOrder($from, $pageSize){
        ...
        //thuc thi truy van
        $query = $conn->query("select * from tbl_order inner join tbl_account on tbl_order.customer_id=tbl_account.account_id order by order_id desc limit $from, $pageSize");
    ...
    public function sentOrdertb($id){
        //lay bien ket noi csdl
        $conn = Connection::getInstance();
        //thuc thi truy van
